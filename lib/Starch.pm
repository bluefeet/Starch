...
and still being tied directly into L<Catalyst>.  Thus Starch was written,
and a very thin glue layer, L<Catalyst::Plugin::Starch>, was created as
...
Method proxies are provided by L<MooX::MethodProxyArgs>, check there for more
details.
